...
function _GameplayStart_js() {
 if (ysdk !== null && ysdk.features !== undefined && ysdk.features.GameplayAPI !== undefined) {
  ...
  if (ysdk == null) console.error("Gameplay start rejected. The SDK is not initialized!"); else console.error("Gameplay start undefined!");
 }
}
...
function _GameplayStop_js() {
 if (ysdk !== null && ysdk.features !== undefined && ysdk.features.GameplayAPI !== undefined) {
  ...
  if (ysdk == null) console.error("Gameplay stop rejected. The SDK is not initialized!"); else console.error("Gameplay stop undefined!");
 }
}
...
function _IsFullscreen_js() {
 if (ysdk !== null) {
  if (ysdk.screen.fullscreen.status == "on") return true; else return false;
 }
 return false;
}
